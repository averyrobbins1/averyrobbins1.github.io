const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5607916&appid=3d90e22f8c2f6bfcb24ee1f9f8004f0d&units=imperial";
fetch(apiURL)
...
const forecast_url = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=3d90e22f8c2f6bfcb24ee1f9f8004f0d&units=imperial"
fetch(forecast_url)
  .then((response) => response.json())
  .then((jsObject) => {
